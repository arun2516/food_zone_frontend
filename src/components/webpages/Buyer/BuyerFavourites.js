...
const BuyerFavourites = () => {
    ...
    const handleFavouriteRemove = item => {
        ...
        axios
            .patch(`https://foodie-zonee.herokuapp.com/buyers/remove_favourite`, {
                item_id: item._id
            }, {
                headers: {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response_1 = await axios.get('https://foodie-zonee.herokuapp.com/items', {
                headers: {
                    authorization: localStorage.getItem("token"),
                },
            });
            const response_2 = await axios.get('https://foodie-zonee.herokuapp.com/buyers/details', {
                headers: {
                    authorization: localStorage.getItem("token"),
                },
            });
            const response_3 = await axios.get('https://foodie-zonee.herokuapp.com/vendors', {
                headers: {
                    authorization: localStorage.getItem("token"),
                },
            });
