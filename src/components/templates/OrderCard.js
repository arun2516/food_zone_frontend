...
const OrderCard = ({ buyer, order, item, vendor, entities, setEntities }) => {
    ...
    const handleRatingChange = value => {
        axios
            .patch(`https://foodie-zonee.herokuapp.com/items/update_rating`, {
                item_id: item._id,
                order_id: order._id,
                rating: value
            }, {
    ...
    const handleStatusUpdate = () => {
        axios
            .patch(`https://foodie-zonee.herokuapp.com/orders/update_state`, {
                order_id: order._id,
            }, {
                headers: {
                    authorization: localStorage.getItem('token')
    ...
    const handleRejection = () => {
        axios
            .patch(`https://foodie-zonee.herokuapp.com/orders/reject`, {
                order_id: order._id,
                buyer_id: buyer._id,
            }, {
                headers: {
